...
class NvnTab extends i {
    constructor() {
        ...
        Object.defineProperty(this, "narrow", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: false
    ...
    render() {
        return x `
			<div
				...
				aria-label=${o(this.name)}
				@click=${this._handleClick}
				@keydown=${this._handleKeyDown}>
				${this.narrow ? x `<slot name="icon"></slot>` : ''}
...
Object.defineProperty(NvnTab, "styles", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: i$3 `
...
class NvnTabBar extends i {
    constructor() {
        ...
        Object.defineProperty(this, "_onTabActivated", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: (ev) => {
...
Object.defineProperty(NvnTabBar, "styles", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: i$3 `
